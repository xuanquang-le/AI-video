...
export const categories = [
  {
    ...
    templates: [
      ...
      { title: "Hiển thị website trong video", slug: "website-demo", cmd: "creative/demo-scroll-sfx", yt: "dang cập nhật", price: "Miễn Phí", desc: "Bản demo màn hình có thêm nhạc nền và âm chuyển cảnh để phần hướng dẫn bớt khô.", fit: "Video giới thiệu sản phẩm, onboarding, tutorial ngắn và bán hàng bằng demo." },
    ],
  },
  {
    slug: "bat-dong-san",
    ...
    templates: [
      ...
      { title: "BĐS đô thị tối", slug: "urban-dark", cmd: "news/real-estate-civic-dark", yt: "dang cập nhật", price: "Miễn Phí", desc: "Bản tin BĐS nền đêm đô thị, accent vàng/cyan, ảnh mở shutter và timeline sắc nét.", fit: "Video thị trường BĐS, quy hoạch, pháp lý dự án và biến động đô thị có sắc thái cao cấp." },
  ...
  },
  {
    ...
    templates: [
      ...
      { title: "Premiere giải trí", slug: "premiere-dark", cmd: "news/entertainment-premiere-dark", yt: "dang cập nhật", price: "Miễn Phí", desc: "Tin giải trí nền tối kiểu sân khấu premiere với poster, quote, timeline và ranking.", fit: "Video về phim, nhạc, awards, nhân vật nổi bật và sự kiện giải trí lớn." },
    ],
  },
  {
    slug: "the-thao",
    ...
    templates: [
      ...
      { title: "Thể thao briefing sáng", slug: "briefing-light", cmd: "news/sports-briefing-light", yt: "dang cập nhật", price: "Miễn Phí", desc: "Bản tin thể thao nền giấy editorial, scoreboard sạch, ảnh/video nguồn và bảng thống kê.", fit: "Recap nhẹ, tin chuyển nhượng, thông tin trước trận và video thể thao dễ đọc." },
    ],
  },
  {
    slug: "suc-khoe",
    ...
    templates: [
      ...
      { title: "Cảnh báo sức khỏe", slug: "alert", cmd: "news/health-public-alert", yt: "dang cập nhật", price: "Miễn Phí", desc: "Bulletin cảnh báo sức khỏe với mức độ rủi ro, nhóm ảnh hưởng, checklist và hành động cần làm.", fit: "Cảnh báo dịch bệnh, an toàn thực phẩm, rủi ro sức khỏe và thông tin khẩn cấp." },
    ],
  },
  {
    slug: "kinh-doanh",
    ...
    templates: [
      ...
      { title: "Sổ cái tài chính", slug: "ledger-light", cmd: "news/business-ledger-light", yt: "dang cập nhật", price: "Miễn Phí", desc: "Bản tin tài chính sáng kiểu financial newspaper với bảng ledger, chỉ số và memo kinh tế.", fit: "Video giải thích chỉ số, báo cáo doanh nghiệp, thị trường và kinh tế vĩ mô." },
    ],
  },
  {
    slug: "du-lich",
    ...
    templates: [
      ...
      { title: "Cẩm nang du lịch", slug: "handbook", cmd: "news/travel-guide-light", yt: "dang cập nhật", price: "Miễn Phí", desc: "Bản tin hướng dẫn du lịch thực dụng với chi phí, lịch trình, checklist, mùa đi và lưu ý.", fit: "Video mẹo du lịch, lịch trình ngắn, hướng dẫn ngân sách và checklist chuẩn bị." },
    ],
  },
  {
    slug: "xe-co",
    ...
    templates: [
      ...
      { title: "Thị trường xe sáng", slug: "market-light", cmd: "news/auto-market-light", yt: "dang cập nhật", price: "Miễn Phí", desc: "Bản tin thị trường xe sáng cho ra mắt, khai tử, xe điện, giá bán và hành vi người mua.", fit: "Tin ngành xe, xu hướng EV, giá bán, chính sách và vòng đời sản phẩm." },
    ],
  },
  {
    slug: "giao-duc",
    ...
    templates: [
      ...
      { title: "Campus bulletin", slug: "campus-bulletin", cmd: "news/education-campus-light", yt: "dang cập nhật", price: "Miễn Phí", desc: "Bản tin giáo dục kiểu campus bulletin với nền sky, notebook cards, deadline và insight học tập.", fit: "Nội dung trường học, tuyển sinh, học bổng, sự kiện campus và thông báo học thuật." },
    ],
  },
  {
    slug: "thoi-su",
    ...
    templates: [
      ...
      { title: "Thời sự tone tối", slug: "dark", cmd: "news/current-affairs-dark", yt: "dang cập nhật", price: "Miễn Phí", desc: "Bản tin thời sự nghiêm túc với nền tối kiểu briefing room, hợp tin chính sách và xã hội.", fit: "Tin chính sách, giao thông, an sinh, cảnh báo xã hội và các chủ đề cần sắc thái nghiêm trang." },
      { title: "Thời sự ảnh slide", slug: "photo-slide", cmd: "news/media-showcase", yt: "dang cập nhật", price: "Miễn Phí", tag: "Mới", desc: "Bản tin thời sự nghiêm túc với nhiều ảnh đường show, viền đỏ, nền trắng, kèm ngày đăng, tiêu đề.", fit: "Tin chính sách, giao thông, an sinh, cảnh báo xã hội và các chủ đề cần sắc thái nghiêm trang." },
    ],
  },
  {
    slug: "cong-nghe",
