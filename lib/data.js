...
export const categories = [
  {
    ...
    templates: [
      { title: "AI tự sáng tạo phong cách", slug: "auto-style", cmd: "creative/free-style-sfx", yt: "oEhqpUD3u3o", price: "Miễn Phí", desc: "AI tự dựng cảnh, chọn màu, animation và chuyển cảnh theo nội dung, có thêm nhạc nền và hiệu ứng âm thanh ở mỗi cảnh để video giàu nhịp hơn.", fit: "Video social sáng tạo đa phong cách, cần cảm giác sống động, có nhịp chuyển cảnh và âm thanh hỗ trợ." },
      ...
      { title: "Pixel Editorial", slug: "pixel-style-sfx", cmd: "creative/pixel-style-sfx", price: "Miễn Phí", desc: "Bản pixel có nhạc nền và transition sound, phù hợp video cần cảm giác arcade/editorial rõ hơn.", fit: "Series ngắn có tính giải trí, review tool, trend công nghệ và nội dung visual mạnh." },
      { title: "Hiển thị website trong video", slug: "website-demo", cmd: "creative/demo-scroll-sfx", price: "Miễn Phí", desc: "Bản demo màn hình có thêm nhạc nền và âm chuyển cảnh để phần hướng dẫn bớt khô.", fit: "Video giới thiệu sản phẩm, onboarding, tutorial ngắn và bán hàng bằng demo." },
    ],
  },
  {
    slug: "bat-dong-san",
    ...
    templates: [
      { title: "BĐS dân sinh sáng", slug: "civic-light", cmd: "news/real-estate-civic-light", yt: "axtP-AmHMfs", price: "Miễn Phí", desc: "Bản tin bất động sản, quy hoạch và đô thị với nền hồng phấn, timeline, quote và ảnh nguồn.", fit: "Tin quy hoạch, nhà ở xã hội, dự án đô thị, hạ tầng và câu chuyện dân sinh." },
      { title: "BĐS đô thị tối", slug: "urban-dark", cmd: "news/real-estate-civic-dark", price: "Miễn Phí", desc: "Bản tin BĐS nền đêm đô thị, accent vàng/cyan, ảnh mở shutter và timeline sắc nét.", fit: "Video thị trường BĐS, quy hoạch, pháp lý dự án và biến động đô thị có sắc thái cao cấp." },
  ...
  },
  {
    ...
    templates: [
      { title: "Tạp chí giải trí", slug: "magazine", cmd: "news/entertainment-magazine-light", yt: "rc_Kl1UrOrs", price: "Miễn Phí", desc: "Tin giải trí tone sáng kiểu tạp chí với ảnh nguồn, quote, timeline và ranking.", fit: "Tin âm nhạc, phim, nhân vật, sách, thời trang và văn hóa đại chúng." },
      { title: "Premiere giải trí", slug: "premiere-dark", cmd: "news/entertainment-premiere-dark", price: "Miễn Phí", desc: "Tin giải trí nền tối kiểu sân khấu premiere với poster, quote, timeline và ranking.", fit: "Video về phim, nhạc, awards, nhân vật nổi bật và sự kiện giải trí lớn." },
    ],
  },
  {
    slug: "the-thao",
    ...
    templates: [
      ...
      { title: "Thể thao briefing sáng", slug: "briefing-light", cmd: "news/sports-briefing-light",yt: "eHWPrlHPAec", price: "Miễn Phí", desc: "Bản tin thể thao nền giấy editorial, scoreboard sạch, ảnh/video nguồn và bảng thống kê.", fit: "Recap nhẹ, tin chuyển nhượng, thông tin trước trận và video thể thao dễ đọc." },
    ],
  },
  {
    slug: "suc-khoe",
    ...
    templates: [
      { title: "Sức khỏe briefing", slug: "briefing", cmd: "news/health-briefing-light", yt: "5hUqsT6rF2M", price: "Miễn Phí", desc: "Tin sức khỏe sáng, sạch, bám nguồn với ảnh/video, số liệu, khuyến cáo và timeline y tế.", fit: "Tin y tế, dinh dưỡng, nghiên cứu sức khỏe và nội dung cộng đồng cần độ tin cậy." },
      { title: "Cảnh báo sức khỏe", slug: "alert", cmd: "news/health-public-alert", price: "Miễn Phí", desc: "Bulletin cảnh báo sức khỏe với mức độ rủi ro, nhóm ảnh hưởng, checklist và hành động cần làm.", fit: "Cảnh báo dịch bệnh, an toàn thực phẩm, rủi ro sức khỏe và thông tin khẩn cấp." },
    ],
  },
  {
    slug: "kinh-doanh",
    ...
    templates: [
      { title: "Terminal kinh doanh", slug: "terminal-dark", cmd: "news/business-terminal-dark", yt: "ou8E5_LfBxk", price: "Miễn Phí", desc: "Bản tin kinh doanh/tài chính tone tối kiểu market terminal với ticker, số liệu và biểu đồ.", fit: "Tin thị trường, chứng khoán, doanh nghiệp, crypto và phân tích rủi ro." },
      { title: "Sổ cái tài chính", slug: "ledger-light", cmd: "news/business-ledger-light", price: "Miễn Phí", desc: "Bản tin tài chính sáng kiểu financial newspaper với bảng ledger, chỉ số và memo kinh tế.", fit: "Video giải thích chỉ số, báo cáo doanh nghiệp, thị trường và kinh tế vĩ mô." },
    ],
  },
  {
    slug: "du-lich",
    ...
    templates: [
      { title: "Postcard du lịch", slug: "postcard", cmd: "news/travel-postcard-light", yt: "OI39lvuKMwU", price: "Miễn Phí", desc: "Bản tin du lịch sáng kiểu postcard với ảnh nguồn, tem địa điểm, route strip và fact card.", fit: "Tin điểm đến, cảnh đẹp, trải nghiệm địa phương và nội dung du lịch cảm hứng." },
      { title: "Cẩm nang du lịch", slug: "handbook", cmd: "news/travel-guide-light", price: "Miễn Phí", desc: "Bản tin hướng dẫn du lịch thực dụng với chi phí, lịch trình, checklist, mùa đi và lưu ý.", fit: "Video mẹo du lịch, lịch trình ngắn, hướng dẫn ngân sách và checklist chuẩn bị." },
    ],
  },
  {
    slug: "xe-co",
    ...
    templates: [
      { title: "Showroom xe tối", slug: "showroom-dark", cmd: "news/auto-showroom-dark", yt: "nUr5VDppdpg", price: "Miễn Phí", desc: "Tin xe tone tối kiểu showroom/road test với ánh đèn, spec cards, gauge và compare board.", fit: "Tin ra mắt xe, đánh giá nhanh, thông số, triệu hồi và so sánh mẫu xe." },
      { title: "Thị trường xe sáng", slug: "market-light", cmd: "news/auto-market-light", price: "Miễn Phí", desc: "Bản tin thị trường xe sáng cho ra mắt, khai tử, xe điện, giá bán và hành vi người mua.", fit: "Tin ngành xe, xu hướng EV, giá bán, chính sách và vòng đời sản phẩm." },
    ],
  },
  {
    slug: "giao-duc",
    ...
    templates: [
      { title: "Giáo dục briefing", slug: "briefing", cmd: "news/education-briefing-light", yt: "L5KkNFRkQ1A", price: "Miễn Phí", desc: "Bản tin giáo dục sáng cho tuyển sinh, du học, đổi mới, deadline, checklist và dữ liệu học thuật.", fit: "Tin tuyển sinh, chính sách giáo dục, du học, chân dung học thuật và deadline quan trọng." },
      { title: "Campus bulletin", slug: "campus-bulletin", cmd: "news/education-campus-light", price: "Miễn Phí", desc: "Bản tin giáo dục kiểu campus bulletin với nền sky, notebook cards, deadline và insight học tập.", fit: "Nội dung trường học, tuyển sinh, học bổng, sự kiện campus và thông báo học thuật." },
    ],
  },
  {
    slug: "thoi-su",
    ...
    templates: [
      { title: "Thời sự tone sáng", slug: "light", cmd: "news/current-affairs-light", yt: "_bFHI-gGTNY", price: "Miễn Phí", desc: "Bản tin chính trị, dân sinh, việc làm và giao thông với nền giấy sáng, accent đỏ son và navy.", fit: "Tin thời sự hằng ngày, chính sách mới, dân sinh và các biến động xã hội cần trình bày rõ." },
      { title: "Thời sự tone tối", slug: "dark", cmd: "news/current-affairs-dark", price: "Miễn Phí", desc: "Bản tin thời sự nghiêm túc với nền tối kiểu briefing room, hợp tin chính sách và xã hội.", fit: "Tin chính sách, giao thông, an sinh, cảnh báo xã hội và các chủ đề cần sắc thái nghiêm trang." },
      { title: "Thời sự ảnh slide", slug: "photo-slide", cmd: "news/media-showcase", price: "Miễn Phí", tag: "Mới", desc: "Bản tin thời sự nghiêm túc với nhiều ảnh đường show, viền đỏ, nền trắng, kèm ngày đăng, tiêu đề.", fit: "Tin chính sách, giao thông, an sinh, cảnh báo xã hội và các chủ đề cần sắc thái nghiêm trang." },
    ],
  },
  {
    slug: "cong-nghe",
