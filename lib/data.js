...
export const categories = [
  ...
  },
  {
    ...
    templates: [
      ...
      { title: "Thể thao briefing sáng", slug: "briefing-light", cmd: "news/sports-briefing-light", price: "Miễn Phí", desc: "Bản tin thể thao nền giấy editorial, scoreboard sạch, ảnh/video nguồn và bảng thống kê.", fit: "Recap nhẹ, tin chuyển nhượng, thông tin trước trận và video thể thao dễ đọc." },
    ],
  },
  {
    slug: "suc-khoe",
