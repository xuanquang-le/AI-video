...
export const categories = [
  ...
  },
  {
    ...
    templates: [
      { title: "Thể thao tone tối", slug: "stadium-dark", cmd: "news/sports-arena-dark", yt: "5iA270GnFz8", price: "Miễn Phí", desc: "Tin thể thao tone tối kiểu sân vận động với scoreboard, tỉ số, timeline, stat board và quote.", fit: "Tổng hợp trận đấu, recap bóng đá, lịch thi đấu, thống kê và điểm nóng thể thao." },
  ...
  },
  {
    ...
    templates: [
      { title: "Công nghệ nền tối", slug: "dark-future", cmd: "news/tech-dark", yt: "WCyljiQUKgs", price: "Miễn Phí", desc: "Bản tin công nghệ với nền tối sâu, gradient cyan-xanh, particle network và cảm giác tương lai.", fit: "Tin AI, startup, chip, thiết bị mới, cybersecurity và các xu hướng công nghệ." },
